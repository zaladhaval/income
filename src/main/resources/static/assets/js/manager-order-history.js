        	...
        	$("#orderHistoryItems").DataTable({
    	        ...
    	        bProcessing: true,
			 	columns:[
			 		...
			 		{"data":"totalPrice","className": "text-right","render":function(data,type,row){return row.currencyUnicode + ' ' + data.toFixed(2)}},
			 	...
			 	"order": [[ 1, "desc" ]],
                ajax: {
                	"url":"manager/get-order-history-for-datatable/0" + phone + "/" + storeId,
                	"type":"POST", 
